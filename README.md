...
## Default posture
Solo implementer + deterministic gate + one adversarial reviewer; **humans merge.** Competitive best-of-N and autonomous auto-merge are *opt-in tiers* you graduate into (ADR-0010), not the default.
