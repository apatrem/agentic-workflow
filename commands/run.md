...
2. **Engine up:** `ao start` (dashboard on :3000). Confirm `agent-orchestrator.yaml` — its `agent` (default `cursor`, i.e. Cursor Composer — ADR-0002 Update) and the gate in `agentRules` match this repo.
