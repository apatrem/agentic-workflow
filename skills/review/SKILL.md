...
> `docs/MODELS.md`** (single source; this command defers to it and names no model versions inline).
...
> (e.g. cursor). At **`low`/`medium`** each reviewer is also **independent of the implementer's lineage**
> (fully clean). At **`hard`**, codex authored a best-of-N attempt and ran the smart-merge — so it is
> cross-lineage but *not* independent; the guarantee there is **≥1 structurally-clean lens** (claude, held out
> of authoring/synthesis — AW-0004).
