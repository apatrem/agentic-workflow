...
> **Solo default:** the routine ~90% path runs one implementer — the **`cursor` agent (Cursor Composer)** by default (ADR-0002 Update, ADR-0004). The biases below apply only to **competitive** best-of-N, where you override the agent per lineage.
